...
from .silver_wolf_interface import SilverWolfInterface
...
class MainWindow(MSFluentWindow):
    ...
    def initInterface(self):
        ...
        self.silverWolfInterface = SilverWolfInterface(self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.silverWolfInterface, FIF.ALBUM, tr('银狼'))
    ...
    def _rebuild_interfaces_for_language(self):
        ...
        try:
            ...
            top_specs = [
                ...
                ('silverWolfInterface', FIF.ALBUM, tr('银狼'), SilverWolfInterface),
