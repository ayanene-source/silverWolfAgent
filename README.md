...
> ## 银狼 Agent 学习版
>
> 本仓库是个人用于学习 Agent 开发的二次开发版本，基于 [moesnow/March7thAssistant](https://github.com/moesnow/March7thAssistant) 修改而来。原项目及本仓库均遵循 [GNU GPL v3.0](LICENSE)；请保留原有版权与许可声明。功能问题请在本仓库的 Issues 中反馈，不要反馈到原项目。
